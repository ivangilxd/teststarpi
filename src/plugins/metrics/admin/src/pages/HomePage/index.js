...
const HomePage = () => {
  ...
  var listChanges;
  useEffect(() => {
    fetch('https://accounting.linarys.com/v1/metricsuser/') 
    .then(res => res.json()) 
    .then(res => {
      console.log(res);
      const data = [res.metrics.total, res.metrics.active, res.metrics.inactive,res.metrics.lost];
      const w = 1000;
      const h = 300;
    ...
    fetch('https://accounting.linarys.com/v1/averagetime/') 
    .then(res => res.json()) 
    .then(res => {
      var aux = res.total;
      var lab="";
    ...
    fetch('https://accounting.linarys.com/v1/topterm/') 
    .then(res => res.json()) 
    .then(res => {
      console.log(res);
    ...
    fetch('https://accounting.linarys.com/v1/lastchanges/') 
    .then(res => res.json()) 
    .then(res => {
      console.log(res);
    ...
    fetch('https://accounting.linarys.com/v1/topmissing/') 
    .then(res => res.json()) 
    .then(res => {
      console.log(res);
